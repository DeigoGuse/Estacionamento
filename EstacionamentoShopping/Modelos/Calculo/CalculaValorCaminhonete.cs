...
{
    public class CalculaValorCaminhonete : ICalculaValor
    {
        ...
        public CalculaValorCaminhonete(IRepositorio<ValoresCalculados> repositorioValoresCalculados, IRepositorio<DataEHorario> repositorioDataEHorario)
        {
