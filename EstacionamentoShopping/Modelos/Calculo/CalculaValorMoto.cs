...
{
    public class CalculaValorMoto : ICalculaValor
    {
        ...
        public CalculaValorMoto(IRepositorio<ValoresCalculados> repositorioValoresCalculados, 
            IRepositorio<DataEHorario> repositorioDataEHorario)
        {
        ...
        public static double CalculaValorFinal(double horasVeiculoNodia, int quantidadeDeUso)
        {
            ...
            else if(horasVeiculoNodia <= 0.25)
            {
                return 0;
            }
            else if (horasVeiculoNodia <= 1)
            {
                return 1.50;
            }
            else
                return ((Math.Ceiling( horasVeiculoNodia) - 1) * 1) + 1.50;
